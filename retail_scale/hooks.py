...
fixtures = [
	{"dt": "DocType", "filters": [["name", "=", "Retail Settings"]]}, 
	{"doctype": "Server Script", "filters": [["module" , "in" , ("Retail Scale")]]},
	{"dt": "Custom Field", "filters": [["dt", "=", "POS Invoice"], ["fieldname", "=", "is_home_delivery"]]}
]